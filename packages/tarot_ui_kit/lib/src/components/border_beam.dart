...
class UiKitBorderBeam extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<UiKitBorderBeam> createState() => _UiKitBorderBeamState();
}

class _UiKitBorderBeamState extends State<UiKitBorderBeam> with SingleTickerProviderStateMixin {
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: BorderBeamPainter(
            ...
            staticBorderColor: widget.staticBorderColor ?? context.colors.grey,
