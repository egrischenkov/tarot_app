...
Icon getPrefixIcon(LoginUserType userType, [Color? color]) {
  switch (userType) {
    case LoginUserType.name:
    case LoginUserType.firstName:
    case LoginUserType.lastName:
    case LoginUserType.text:
    case LoginUserType.checkbox:
      return Icon(FontAwesomeIcons.circleUser, color: color);
    case LoginUserType.phone:
    case LoginUserType.intlPhone:
      return Icon(FontAwesomeIcons.squarePhoneFlip, color: color);
    case LoginUserType.email:
      return Icon(FontAwesomeIcons.squareEnvelope, color: color);
  }
}
