...
class AnimatedText extends StatefulWidget {
  ...
  const AnimatedText({required this.text, super.key, this.style, this.textRotation = AnimatedTextRotation.up});
...
class _AnimatedTextState extends State<AnimatedText> with SingleTickerProviderStateMixin {
  ...
  Matrix4 _getFrontSideUp(double value) {
    return _matrix
      ..translate(0.0, -radius * sin(_animation.value), -radius * cos(_animation.value))
      ..rotateX(-_animation.value); // 0 -> -pi/2
  }

  Matrix4 _getBackSideUp(double value) {
    return _matrix
      ..translate(0.0, radius * cos(_animation.value), -radius * sin(_animation.value))
  ...
  Widget build(BuildContext context) {
    ...
    final oldText = Text(_oldText, key: _textKey, style: widget.style, overflow: TextOverflow.visible, softWrap: false);
    final newText = Text(_newText, style: widget.style, overflow: TextOverflow.visible, softWrap: false);
