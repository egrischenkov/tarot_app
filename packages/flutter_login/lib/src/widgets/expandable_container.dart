...
class _ExpandableContainerState extends State<ExpandableContainer> {
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(begin: const Offset(-1, 0), end: Offset.zero).animate(
      CurvedAnimation(parent: _controller, curve: const Interval(.6875, 1, curve: Curves.fastOutSlowIn)),
  ...
  Widget build(BuildContext context) {
    return SizeTransition(
      ...
      child: Stack(
        children: <Widget>[
          Positioned.fill(child: DecoratedBox(decoration: BoxDecoration(color: widget.backgroundColor))),
          SlideTransition(
