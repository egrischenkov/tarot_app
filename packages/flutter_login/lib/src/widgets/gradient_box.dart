...
class GradientBox extends StatelessWidget {
  ...
  const GradientBox({super.key, this.colors, this.begin = Alignment.topLeft, this.end = Alignment.bottomRight})
    : assert(colors != null && colors.length >= 2, 'The "colors" parameter must contain at least two colors.');
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      decoration: BoxDecoration(gradient: LinearGradient(colors: colors!, begin: begin, end: end, stops: const [0, 1])),
