...
Widget defaultFlutterLogin() {
  return MaterialApp(
    home: FlutterLogin(onSignup: (data) => null, onLogin: (data) => null, onRecoverPassword: (data) => null),
  );
}
...
Future<void> simulateOpenSoftKeyboard(WidgetTester tester, Widget widget) async {
