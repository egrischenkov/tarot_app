...
void main() {
  ...
  testWidgets('showDebugButtons = false should not show debug buttons', (WidgetTester tester) async {
    ...
    flutterLogin = widget(
      FlutterLogin(onSignup: (data) => null, onLogin: (data) => null, onRecoverPassword: (data) => null),
    );
    await tester.pumpWidget(flutterLogin);
    await tester.pumpAndSettle(loadingAnimationDuration);
  ...
  testWidgets('Leave title parameter empty should not display login title', (WidgetTester tester) async {
    var flutterLogin = widget(
      FlutterLogin(onSignup: (data) => null, onLogin: (data) => null, onRecoverPassword: (data) => null, title: ''),
    );
    await tester.pumpWidget(flutterLogin);
    await tester.pumpAndSettle(loadingAnimationDuration);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      verifyInOrder([mockCallback.userValidator('invalid-name'), mockCallback.passwordValidator(user.password)]);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      Widget loginBuilder() => widget(
        FlutterLogin(
          ...
          additionalSignupFields: <UserFormField>[
            UserFormField(keyName: 'Name', fieldValidator: mockCallback.userValidator),
            UserFormField(keyName: 'Surname', fieldValidator: mockCallback.userValidator),
          ],
        ),
      );
      await tester.pumpWidget(loginBuilder());
      ...
      expect(find.text('Please fill in this form to complete the signup'), findsOneWidget);
  ...
  testWidgets('hideSignUpButton & hideForgotPasswordButton should hide SignUp and forgot password button', (
    WidgetTester tester,
  ) async {
    Widget loginBuilder() => widget(
      FlutterLogin(
        ...
        messages: LoginMessages(signupButton: 'REGISTER', forgotPasswordButton: 'Forgot huh?'),
      ),
    );
    await tester.pumpWidget(loginBuilder());
    await tester.pumpAndSettle(loadingAnimationDuration);
    ...
    (WidgetTester tester) async {
      ...
      Widget loginBuilder() => widget(
        FlutterLogin(
          ...
          onRecoverPassword: (data) => null,
          passwordValidator: (value) => null,
          additionalSignupFields: const [UserFormField(keyName: 'Name'), UserFormField(keyName: 'Surname')],
        ),
      );
      await tester.pumpWidget(loginBuilder());
      await tester.pumpAndSettle(loadingAnimationDuration);
  ...
  testWidgets('Redirect to login page after sign up with additional fields when loginAfterSignup is false', (
    WidgetTester tester,
  ) async {
    Widget loginBuilder() => widget(
      FlutterLogin(
